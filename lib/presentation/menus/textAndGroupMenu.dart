...
class GroupMenu extends StatelessWidget {
  final FlowElement groupElement;
  final ValueNotifier<double> sliderSize;
  final ValueNotifier<bool> isBold;
  final TextEditingController textController;
  ...
  })  : sliderSize = ValueNotifier(groupElement.textSize),
        isBold = ValueNotifier(groupElement.textIsBold),
        textController = TextEditingController(text: groupElement.text);
    ...
    return [
      SizedBox(
        ...
        child: TextField(
          ...
          minLines: null,
          maxLines: null,
          onChanged: (value) => groupElement.setText(value),
        ),
      ),
      Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          IconMenu(
            text: 'Color',
            icon: CircleWidget(backgroundColor: groupElement.textColor),
          ).addStarMenu(
            items: [
              SizedBox(
                width: 300,
                child: FittedBox(
                  child: SizedBox(
                    ...
                    height: 400,
                    child: HueRingPicker(
                      onColorChanged: groupElement.setTextColor,
                      pickerColor: groupElement.textColor,
                      portraitOnly: true,
                    ),
                  ),
                ),
                ...
                return Row(
                  ...
                  children: [
                    ...
                    Checkbox(
                      ...
                      onChanged: ((value) {
                        isBold.value = value!;
                        groupElement.setTextIsBold(value);
                      }),
                    ),
                  ],
                );
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Slider.adaptive(
                    ...
                    onChanged: (v) {
                      sliderSize.value = v;
                      groupElement.setTextSize(value);
                    },
                  ),
                ),
              ],
...
class groupIconMenu extends StatelessWidget {
  final Widget icon;
